...
output "sa_key" {
  value       = { for k, v in var.sa_permissions : k => google_service_account_key.services_sa_key[k].private_key }
  description = "Service account private key in JSON format, base64 encoded."
}
